...
public class SpaceshipCamera : MonoBehaviour
{
    ...
    public void SetFollowTransform(Transform t)
    {
        ...
        VerticalDirection = FollowTransform.forward;
    ...
    public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
    {
        if (FollowTransform)
        {
            ...
            Quaternion rotationFromInput = Quaternion.Euler(Vector3.up * (rotationInput.x * RotationSpeed));    //Followtransform.up to vector3.up, camera now displays the behaviour I want
            ...
            Debug.DrawRay(transform.position, PlanarDirection * 5f, Color.blue);
            ...
            //Currently the targetRotation does not at all do what it is supposed to, only when it is perfectly level does it work...
            Debug.DrawRay(transform.position, targetRotation * FollowTransform.forward * 5f);
